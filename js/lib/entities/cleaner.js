...
Cleaner.prototype.tick = function() {
  ...
  if (this.distanceTo(this.moveTarget) < 20) {
    ...
    this.moveTarget = {
      x: _.random(this.game.canvas.width),
      y: _.random(this.game.canvas.height)
    };
