require.config({
  shim: {
    ...
    "lib/levels/levels": {
      deps: ["lib/level", "lib/levels/breaklevel"]
    },
    ...
    "lib/entities/bulletricochet": {
      deps: ["lib/entity", "lib/entities/bullet"]
    },
    ...
    "lib/entities/enemyspawner": { deps: ["lib/entity", "lib/entities/enemy"] },
